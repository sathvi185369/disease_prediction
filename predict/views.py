...
def prediction(request):
    ...
    symptom7 = request.GET.get("symptom7")
    symptom8 = request.GET.get("symptom8")
    symptom9 = request.GET.get("symptom9")
    symptom10 = request.GET.get("symptom10")
    ...
    if symptom6 in disease:
        disease[symptom6] = 1
    if symptom7 in disease:
        disease[symptom7] = 1
    if symptom8 in disease:
        disease[symptom8] = 1
    if symptom9 in disease:
        disease[symptom9] = 1
    if symptom10 in disease:
        disease[symptom10] = 1
    ...
    symptoms.append("Symptom6: " + symptom6)
    symptoms.append("Symptom7: " + symptom7)
    symptoms.append("Symptom8: " + symptom8)
    symptoms.append("Symptom9: " + symptom9)
    symptoms.append("Symptom10: " + symptom10)
