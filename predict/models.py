...
class Report(models.Model):
    ...
    symptom7 = models.CharField(max_length=30, blank=True)
    symptom8 = models.CharField(max_length=30, blank=True)
    symptom9 = models.CharField(max_length=30, blank=True)
    symptom10 = models.CharField(max_length=30, blank=True)
